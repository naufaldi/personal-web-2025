  ...
  return (
    <aside className="hidden lg:block w-64 flex-shrink-0">
      <div className="sticky top-24">
        <div
          className="border border-slate-800/70 bg-slate-900/80 rounded-lg p-4 max-h-[calc(100vh-8rem)] overflow-y-auto"
          style={{
        ...
        >
          <h3
            className="text-sm text-slate-200 mb-4 font-semibold"
            style={{
                  ...
                  <div className="flex items-center gap-1">
                    {hasH3s && (
                      <button
                        ...
                        className="flex-shrink-0 p-0.5 text-slate-400 hover:text-slate-200 transition-colors rounded"
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? 'bg-slate-800/90 text-slate-50 font-medium'
