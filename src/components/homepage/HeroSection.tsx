  ...
  return (
    <section className="relative flex-1">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center pb-12 pt-16 sm:py-16 lg:py-24">
          <FadeInUp
            delay={
              0.12
            }
          >
            <div className="space-y-7">
              ...
              <h1
                className="text-2xl sm:text-[32px] md:text-[40px] leading-[1.15] text-slate-100 tracking-tight"
                style={{
                  fontFamily:
                    "var(--font-mono)",
                  fontWeight: 500,
