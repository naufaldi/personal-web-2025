  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col sm:flex-row">
          <div className="flex-1 p-3 sm:p-4 md:p-5 space-y-2 flex flex-col justify-center">
            <CardHeader className="space-y-1.5 p-0">
              <h3
                className="text-sm sm:text-base md:text-lg text-slate-100"
                style={{
                  fontFamily:
                    "var(--font-mono)",
                  fontWeight: 500,
        ...
        <div className="border-t border-slate-800/70 p-3 sm:p-4 md:p-4 space-y-2 sm:space-y-3">
              ...
              (
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-1 sm:gap-1.5 rounded border border-slate-800/70 bg-slate-900/80 px-2 py-1 text-xs"
                    title={
                      tech
                    }
                  >
                    <Icon className="h-3 sm:h-3.5 w-3 sm:w-3.5 text-slate-400" />
                    <span
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              ...
              className="inline-flex items-center gap-1 sm:gap-1.5 rounded-md border border-slate-800/70 bg-slate-900/60 px-3 sm:px-4 py-2 text-xs sm:text-sm text-slate-300 transition-all duration-200 hover:border-slate-700/70 hover:bg-slate-900/90 hover:text-slate-100 hover:shadow-md hover:shadow-slate-900/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-100/40"
              style={{
                fontFamily:
                  "var(--font-body)",
                fontWeight: 600,
