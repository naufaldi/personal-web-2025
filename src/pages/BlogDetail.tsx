                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <Badge
                        variant="outline"
                        className="border-slate-700/70 light:border-slate-300/70 bg-slate-900/40 light:bg-slate-100/40 text-slate-400 light:text-slate-600"
                        style={{
                          fontFamily:
                            "var(--font-body)",
                          fontWeight: 500,
                    ...
                    <h1
                      className="text-3xl md:text-4xl mb-2 text-slate-100 light:text-slate-900"
                      style={{
                        fontFamily:
                          "var(--font-mono)",
                        fontWeight: 700,
                    ...
                    <p
                      className="text-base md:text-lg mb-4 text-slate-300 light:text-slate-700"
                      style={{
                        fontFamily:
                          "var(--font-body)",
                        fontWeight: 400,
