...
const ProjectBackground = () => (
  <svg
    ...
    className="absolute overflow-hidden top-6 inset-x-0 md:top-10 lg:w-full z-[-1] md:max-w-[68rem] lg:max-w-7xl mx-auto opacity-30 md:opacity-50 lg:opacity-70 text-slate-100/20 light:text-slate-500/40"
    aria-hidden="true"
  >
    <path
      ...
      <div className="mx-auto max-w-7xl px-6 w-full relative z-10 py-20 md:py-16">
        <FadeInUp delay={0.06}>
          <div className="px-6 md:px-0 flex flex-col items-center gap-4 mb-12">
            ...
            >
              <span className="text-slate-100 light:text-slate-900">Curated </span>
              <span className="text-slate-300 light:text-slate-600">Projects</span>
            </h1>
            <p
